...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Nn,depthTest:!1,depthWrite:!1})}function hg(i,e,t){const n=new Float32Array(yi),s=new L(0,1,0);return new Gt({name:"SphericalGaussianBlur",defines:{n:yi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:ga(),fragmentShader:`
		...
		`,blending:Nn,depthTest:!1,depthWrite:!1})}function Yc(){return new Gt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ga(),fragmentShader:`
		...
		`,blending:Nn,depthTest:!1,depthWrite:!1})}function qc(){return new Gt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ga(),fragmentShader:`
...
`)}const m0={[Ml]:"Linear",[Sl]:"Reinhard",[bl]:"Cineon",[la]:"ACESFilmic",[El]:"AgX",[Tl]:"Neutral",[yl]:"Custom"};function g0(i,e){const t=m0[e];return t===void 0?(Ie("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Pr=new L;function _0(){Ze.getLuminanceCoefficients(Pr);const i=Pr.x.toFixed(4),e=Pr.y.toFixed(4),t=Pr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`].filter(Ns).join(`
`)),a=al(a),a=ih(a,t),a=sh(a,t),o=al(o),o=ih(o,t),o=sh(o,t),a=rh(a),o=rh(o),t.isRawShaderMaterial!==!0&&(S=`#version 300 es
